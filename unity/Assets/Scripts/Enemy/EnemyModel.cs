...
namespace AI.Unit.Enemy
{
    public class EnemyModel
    {
        ...
        public EnemyModel()
        {
            ...
            Hp = maxHp;
            Mp = maxMp;
            Behaviors.Add(0, new AIModel(AIModel.Subject.Enemy, AIModel.Criterion.Hp, 0, 100, AIModel.Behavior.Escape));
            Behaviors.Add(1, new AIModel(AIModel.Subject.Enemy, AIModel.Criterion.Mp, 0, 100, AIModel.Behavior.Escape));
        }
